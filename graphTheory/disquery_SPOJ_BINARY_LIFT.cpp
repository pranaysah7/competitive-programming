...
// //----------------------------------------------------------------------------------------------------------------
// const int N=1e5+10;
// pair<int,pair<int,int>>lca[N][20];
// vi adj[N];
// int level[N];
...
// 				lca[i][j].ss.ff=min(lca[i][j-1].ss.ff,lca[par][j-1].ss.ff);
// 				lca[i][j].ss.ss=max(lca[i][j-1].ss.ss,lca[par][j-1].ss.ss);
// 			}
// 		}
// 	}
// }
...
// 		int i=log2(d);
// 		b=lca[b][i].ff;
// 		a1=min(a1,lca[b][i].ss.ff);
// 		a2=max(a2,lca[b][i].ss.ss);
// 		d-=1<<i;
// 	}
// 	if(a==b){return;}
// 	for(;p>=0;p--)
// 	{
// 		if(lca[a][p].ff!=-1 and lca[a][p].ff!=lca[b][p].ff)
// 		{
// 			a=lca[a][p].ff;
// 			b=lca[b][p].ff;
// 			a1=min(a1,lca[a][p].ss.ff);
// 			a2=max(a2,lca[a][p].ss.ss);
// 			a1=min(a1,lca[b][p].ss.ff);
// 			a2=max(a2,lca[b][p].ss.ss);
// 		}
// 	}
// 	deb(a);
// 	deb(lca[a][0]);
...
// for(int i=1;i<=n;i++)
// {
// 	cout<<lca[i][0].ss.ff<<tabl<<lca[i][0].ss.ss<<endl;
// }
// dfs(1,-1,1);
// int p=log2(n);
// buildparent(n,p);
