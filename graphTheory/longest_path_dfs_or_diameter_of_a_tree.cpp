...
dfs(r,0);//find the longest leaf node
vis.assign(n+1,0);//set visisted array to be 0
maxD=-infi;
dfs(maxnode,0);//dfs again from the longest leaf node to find the largest length of a tree
cout<<maxD<<endl;
